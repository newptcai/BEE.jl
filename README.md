...
*This package has been renamed as [`BeeEncoder.jl`](https://github.com/newptcai/BeeEncoder.jl).  The name was changed so it can be registered in Julia's package repository.*
